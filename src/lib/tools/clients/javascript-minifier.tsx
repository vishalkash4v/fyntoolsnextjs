...
const Tool = dynamic(() => import("@/components/tools/JavaScriptMinifier"), {
  ssr: true,
  loading: () => (
    <div
      ...
      aria-busy="true"
      aria-label="Loading Java Script Minifier"
      role="status"
    >
      Loading tool…
    </div>
...
/** Dedicated island — only loads JavaScriptMinifier, not the multi-tool registry. */
