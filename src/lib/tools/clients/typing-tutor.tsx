...
const Tool = dynamic(() => import("@/components/tools/TypingTutor"), {
  ssr: false,
  loading: () => (
    <div
      ...
      aria-busy="true"
      aria-label="Loading Typing Tutor"
      role="status"
    >
      Loading tool…
    </div>
...
/** Dedicated island — only loads TypingTutor, not the multi-tool registry. */
