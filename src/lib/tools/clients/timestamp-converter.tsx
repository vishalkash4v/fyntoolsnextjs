...
const Tool = dynamic(() => import("@/components/tools/TimestampConverter"), {
  ssr: true,
  loading: () => (
    <div
      ...
      aria-busy="true"
      aria-label="Loading Timestamp Converter"
      role="status"
    >
      Loading tool…
    </div>
...
/** Dedicated island — only loads TimestampConverter, not the multi-tool registry. */
