...
const Tool = dynamic(() => import("@/components/tools/BoxShadowGenerator"), {
  ssr: true,
  loading: () => (
    <div
      ...
      aria-busy="true"
      aria-label="Loading Box Shadow Generator"
      role="status"
    >
      Loading tool…
    </div>
...
/** Dedicated island — only loads BoxShadowGenerator, not the multi-tool registry. */
