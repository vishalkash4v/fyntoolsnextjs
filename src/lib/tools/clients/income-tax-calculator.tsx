...
const Tool = dynamic(() => import("@/components/tools/IncomeTaxCalculator"), {
  ssr: false,
  loading: () => (
    <div
      ...
      aria-busy="true"
      aria-label="Loading Income Tax Calculator"
      role="status"
    >
      Loading tool…
    </div>
...
/** Dedicated island — only loads IncomeTaxCalculator, not the multi-tool registry. */
