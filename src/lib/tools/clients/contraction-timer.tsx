...
const Tool = dynamic(() => import("@/components/tools/ContractionTimer"), {
  ssr: false,
  loading: () => (
    <div
      ...
      aria-busy="true"
      aria-label="Loading Contraction Timer"
      role="status"
    >
      Loading tool…
    </div>
...
/** Dedicated island — only loads ContractionTimer, not the multi-tool registry. */
