...
const Tool = dynamic(() => import("@/components/tools/AiTextRewriter"), {
  ssr: true,
  loading: () => (
    <div
      ...
      aria-busy="true"
      aria-label="Loading Ai Text Rewriter"
      role="status"
    >
      Loading tool…
    </div>
...
/** Dedicated island — only loads AiTextRewriter, not the multi-tool registry. */
