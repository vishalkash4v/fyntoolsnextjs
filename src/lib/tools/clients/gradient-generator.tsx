...
const Tool = dynamic(() => import("@/components/tools/GradientGenerator"), {
  ssr: true,
  loading: () => (
    <div
      ...
      aria-busy="true"
      aria-label="Loading Gradient Generator"
      role="status"
    >
      Loading tool…
    </div>
...
/** Dedicated island — only loads GradientGenerator, not the multi-tool registry. */
