...
const Tool = dynamic(() => import("@/components/tools/TextFontChanger"), {
  ssr: false,
  loading: () => (
    <div
      ...
      aria-busy="true"
      aria-label="Loading Text Font Changer"
      role="status"
    >
      Loading tool…
    </div>
...
/** Dedicated island — only loads TextFontChanger, not the multi-tool registry. */
