...
const Tool = dynamic(() => import("@/components/tools/PregnancyDueDateCalculator"), {
  ssr: true,
  loading: () => (
    <div
      ...
      aria-busy="true"
      aria-label="Loading Pregnancy Due Date Calculator"
      role="status"
    >
      Loading tool…
    </div>
...
/** Dedicated island — only loads PregnancyDueDateCalculator, not the multi-tool registry. */
