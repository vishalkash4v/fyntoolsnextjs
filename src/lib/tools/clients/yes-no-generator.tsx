...
const Tool = dynamic(() => import("@/components/tools/YesNoGenerator"), {
  ssr: false,
  loading: () => (
    <div
      ...
      aria-busy="true"
      aria-label="Loading Yes No Generator"
      role="status"
    >
      Loading tool…
    </div>
...
/** Dedicated island — only loads YesNoGenerator, not the multi-tool registry. */
