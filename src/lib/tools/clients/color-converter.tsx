...
const Tool = dynamic(() => import("@/components/tools/ColorConverter"), {
  ssr: true,
  loading: () => (
    <div
      ...
      aria-busy="true"
      aria-label="Loading Color Converter"
      role="status"
    >
      Loading tool…
    </div>
...
/** Dedicated island — only loads ColorConverter, not the multi-tool registry. */
