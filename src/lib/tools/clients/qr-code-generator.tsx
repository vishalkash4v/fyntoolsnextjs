...
const Tool = dynamic(() => import("@/components/tools/QRCodeGenerator"), {
  ssr: true,
  loading: () => (
    <div
      ...
      aria-busy="true"
      aria-label="Loading Q R Code Generator"
      role="status"
    >
      Loading tool…
    </div>
...
/** Dedicated island — only loads QRCodeGenerator, not the multi-tool registry. */
