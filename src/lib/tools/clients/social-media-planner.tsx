...
const Tool = dynamic(() => import("@/components/tools/SocialMediaPlanner"), {
  ssr: true,
  loading: () => (
    <div
      ...
      aria-busy="true"
      aria-label="Loading Social Media Planner"
      role="status"
    >
      Loading tool…
    </div>
...
/** Dedicated island — only loads SocialMediaPlanner, not the multi-tool registry. */
