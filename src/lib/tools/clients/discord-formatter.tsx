...
const Tool = dynamic(() => import("@/components/tools/DiscordFormatter"), {
  ssr: true,
  loading: () => (
    <div
      ...
      aria-busy="true"
      aria-label="Loading Discord Formatter"
      role="status"
    >
      Loading tool…
    </div>
...
/** Dedicated island — only loads DiscordFormatter, not the multi-tool registry. */
