...
const Tool = dynamic(() => import("@/components/tools/InvertImageColors"), {
  ssr: false,
  loading: () => (
    <div
      ...
      aria-busy="true"
      aria-label="Loading Invert Image Colors"
      role="status"
    >
      Loading tool…
    </div>
...
/** Dedicated island — only loads InvertImageColors, not the multi-tool registry. */
