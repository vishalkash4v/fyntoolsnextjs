...
const Tool = dynamic(() => import("@/components/tools/ImageToText"), {
  ssr: false,
  loading: () => (
    <div
      ...
      aria-busy="true"
      aria-label="Loading Image To Text"
      role="status"
    >
      Loading tool…
    </div>
...
/** Dedicated island — only loads ImageToText, not the multi-tool registry. */
