...
const Tool = dynamic(() => import("@/components/tools/HtmlFormatter"), {
  ssr: true,
  loading: () => (
    <div
      ...
      aria-busy="true"
      aria-label="Loading Html Formatter"
      role="status"
    >
      Loading tool…
    </div>
...
/** Dedicated island — only loads HtmlFormatter, not the multi-tool registry. */
