...
const Tool = dynamic(() => import("@/components/tools/UrlSlugGenerator"), {
  ssr: true,
  loading: () => (
    <div
      ...
      aria-busy="true"
      aria-label="Loading Url Slug Generator"
      role="status"
    >
      Loading tool…
    </div>
...
/** Dedicated island — only loads UrlSlugGenerator, not the multi-tool registry. */
