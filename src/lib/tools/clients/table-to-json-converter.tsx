...
const Tool = dynamic(() => import("@/components/tools/TableToJsonConverter"), {
  ssr: true,
  loading: () => (
    <div
      ...
      aria-busy="true"
      aria-label="Loading Table To Json Converter"
      role="status"
    >
      Loading tool…
    </div>
...
/** Dedicated island — only loads TableToJsonConverter, not the multi-tool registry. */
