...
const Tool = dynamic(() => import("@/components/tools/TimetableMaker"), {
  ssr: true,
  loading: () => (
    <div
      ...
      aria-busy="true"
      aria-label="Loading Timetable Maker"
      role="status"
    >
      Loading tool…
    </div>
...
/** Dedicated island — only loads TimetableMaker, not the multi-tool registry. */
