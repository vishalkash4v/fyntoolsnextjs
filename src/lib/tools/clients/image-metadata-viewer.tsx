...
const Tool = dynamic(() => import("@/components/tools/ImageMetadataViewer"), {
  ssr: false,
  loading: () => (
    <div
      ...
      aria-busy="true"
      aria-label="Loading Image Metadata Viewer"
      role="status"
    >
      Loading tool…
    </div>
...
/** Dedicated island — only loads ImageMetadataViewer, not the multi-tool registry. */
