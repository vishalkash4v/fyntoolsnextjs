...
const Tool = dynamic(() => import("@/components/tools/HashGenerator"), {
  ssr: false,
  loading: () => (
    <div
      ...
      aria-busy="true"
      aria-label="Loading Hash Generator"
      role="status"
    >
      Loading tool…
    </div>
...
/** Dedicated island — only loads HashGenerator, not the multi-tool registry. */
