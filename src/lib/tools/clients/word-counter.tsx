...
const Tool = dynamic(() => import("@/components/tools/WordCounter"), {
  ssr: true,
  loading: () => (
    <div
      ...
      aria-busy="true"
      aria-label="Loading Word Counter"
      role="status"
    >
      Loading tool…
    </div>
...
/** Dedicated island — only loads WordCounter, not the multi-tool registry. */
