...
const Tool = dynamic(() => import("@/components/tools/BorderRadiusGenerator"), {
  ssr: false,
  loading: () => (
    <div
      ...
      aria-busy="true"
      aria-label="Loading Border Radius Generator"
      role="status"
    >
      Loading tool…
    </div>
...
/** Dedicated island — only loads BorderRadiusGenerator, not the multi-tool registry. */
