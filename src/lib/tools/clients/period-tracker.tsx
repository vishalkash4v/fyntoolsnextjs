...
const Tool = dynamic(() => import("@/components/tools/PeriodTracker"), {
  ssr: true,
  loading: () => (
    <div
      ...
      aria-busy="true"
      aria-label="Loading Period Tracker"
      role="status"
    >
      Loading tool…
    </div>
...
/** Dedicated island — only loads PeriodTracker, not the multi-tool registry. */
