...
const Tool = dynamic(() => import("@/components/tools/ButtonGenerator"), {
  ssr: true,
  loading: () => (
    <div
      ...
      aria-busy="true"
      aria-label="Loading Button Generator"
      role="status"
    >
      Loading tool…
    </div>
...
/** Dedicated island — only loads ButtonGenerator, not the multi-tool registry. */
