...
const Tool = dynamic(() => import("@/components/tools/MetaTagPreviewer"), {
  ssr: false,
  loading: () => (
    <div
      ...
      aria-busy="true"
      aria-label="Loading Meta Tag Previewer"
      role="status"
    >
      Loading tool…
    </div>
...
/** Dedicated island — only loads MetaTagPreviewer, not the multi-tool registry. */
