...
const Tool = dynamic(() => import("@/components/tools/PregnancyWeightGainCalculator"), {
  ssr: false,
  loading: () => (
    <div
      ...
      aria-busy="true"
      aria-label="Loading Pregnancy Weight Gain Calculator"
      role="status"
    >
      Loading tool…
    </div>
...
/** Dedicated island — only loads PregnancyWeightGainCalculator, not the multi-tool registry. */
