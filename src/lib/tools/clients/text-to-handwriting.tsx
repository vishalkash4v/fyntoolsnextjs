...
const Tool = dynamic(() => import("@/components/tools/TextToHandwriting"), {
  ssr: false,
  loading: () => (
    <div
      ...
      aria-busy="true"
      aria-label="Loading Text To Handwriting"
      role="status"
    >
      Loading tool…
    </div>
...
/** Dedicated island — only loads TextToHandwriting, not the multi-tool registry. */
