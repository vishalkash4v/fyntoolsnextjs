...
const Tool = dynamic(() => import("@/components/tools/TextCaseConverter"), {
  ssr: false,
  loading: () => (
    <div
      ...
      aria-busy="true"
      aria-label="Loading Text Case Converter"
      role="status"
    >
      Loading tool…
    </div>
...
/** Dedicated island — only loads TextCaseConverter, not the multi-tool registry. */
