...
const Tool = dynamic(() => import("@/components/tools/UnitConverter"), {
  ssr: false,
  loading: () => (
    <div
      ...
      aria-busy="true"
      aria-label="Loading Unit Converter"
      role="status"
    >
      Loading tool…
    </div>
...
/** Dedicated island — only loads UnitConverter, not the multi-tool registry. */
