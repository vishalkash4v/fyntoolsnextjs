...
const Tool = dynamic(() => import("@/components/tools/SocialMediaDownloader"), {
  ssr: false,
  loading: () => (
    <div
      ...
      aria-busy="true"
      aria-label="Loading Social Media Downloader"
      role="status"
    >
      Loading tool…
    </div>
...
/** Dedicated island — only loads SocialMediaDownloader, not the multi-tool registry. */
