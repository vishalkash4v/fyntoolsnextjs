...
const Tool = dynamic(() => import("@/components/tools/LoremIpsumGenerator"), {
  ssr: false,
  loading: () => (
    <div
      ...
      aria-busy="true"
      aria-label="Loading Lorem Ipsum Generator"
      role="status"
    >
      Loading tool…
    </div>
...
/** Dedicated island — only loads LoremIpsumGenerator, not the multi-tool registry. */
