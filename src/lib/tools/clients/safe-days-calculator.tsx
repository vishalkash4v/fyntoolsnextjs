...
const Tool = dynamic(() => import("@/components/tools/SafeDaysCalculator"), {
  ssr: false,
  loading: () => (
    <div
      ...
      aria-busy="true"
      aria-label="Loading Safe Days Calculator"
      role="status"
    >
      Loading tool…
    </div>
...
/** Dedicated island — only loads SafeDaysCalculator, not the multi-tool registry. */
