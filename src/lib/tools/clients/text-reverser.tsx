...
const Tool = dynamic(() => import("@/components/tools/TextReverser"), {
  ssr: true,
  loading: () => (
    <div
      ...
      aria-busy="true"
      aria-label="Loading Text Reverser"
      role="status"
    >
      Loading tool…
    </div>
...
/** Dedicated island — only loads TextReverser, not the multi-tool registry. */
