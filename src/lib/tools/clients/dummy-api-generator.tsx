...
const Tool = dynamic(() => import("@/components/tools/DummyAPIGenerator"), {
  ssr: false,
  loading: () => (
    <div
      ...
      aria-busy="true"
      aria-label="Loading Dummy A P I Generator"
      role="status"
    >
      Loading tool…
    </div>
...
/** Dedicated island — only loads DummyAPIGenerator, not the multi-tool registry. */
