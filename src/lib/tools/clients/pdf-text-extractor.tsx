...
const Tool = dynamic(() => import("@/components/tools/PdfTextExtractor"), {
  ssr: false,
  loading: () => (
    <div
      ...
      aria-busy="true"
      aria-label="Loading Pdf Text Extractor"
      role="status"
    >
      Loading tool…
    </div>
...
/** Dedicated island — only loads PdfTextExtractor, not the multi-tool registry. */
