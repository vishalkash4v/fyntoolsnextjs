...
const Tool = dynamic(() => import("@/components/tools/TypingGames"), {
  ssr: false,
  loading: () => (
    <div
      ...
      aria-busy="true"
      aria-label="Loading Typing Games"
      role="status"
    >
      Loading tool…
    </div>
...
/** Dedicated island — only loads TypingGames, not the multi-tool registry. */
