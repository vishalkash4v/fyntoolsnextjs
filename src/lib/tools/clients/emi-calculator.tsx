...
const Tool = dynamic(() => import("@/components/tools/EmiCalculator"), {
  ssr: true,
  loading: () => (
    <div
      ...
      aria-busy="true"
      aria-label="Loading Emi Calculator"
      role="status"
    >
      Loading tool…
    </div>
...
/** Dedicated island — only loads EmiCalculator, not the multi-tool registry. */
