...
const Tool = dynamic(() => import("@/components/tools/FutureDateCalculator"), {
  ssr: false,
  loading: () => (
    <div
      ...
      aria-busy="true"
      aria-label="Loading Future Date Calculator"
      role="status"
    >
      Loading tool…
    </div>
...
/** Dedicated island — only loads FutureDateCalculator, not the multi-tool registry. */
