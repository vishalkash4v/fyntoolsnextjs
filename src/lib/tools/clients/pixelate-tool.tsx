...
const Tool = dynamic(() => import("@/components/tools/PixelateTool"), {
  ssr: false,
  loading: () => (
    <div
      ...
      aria-busy="true"
      aria-label="Loading Pixelate Tool"
      role="status"
    >
      Loading tool…
    </div>
...
/** Dedicated island — only loads PixelateTool, not the multi-tool registry. */
