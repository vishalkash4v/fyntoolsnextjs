...
const Tool = dynamic(() => import("@/components/tools/XmlSitemapTester"), {
  ssr: true,
  loading: () => (
    <div
      ...
      aria-busy="true"
      aria-label="Loading Xml Sitemap Tester"
      role="status"
    >
      Loading tool…
    </div>
...
/** Dedicated island — only loads XmlSitemapTester, not the multi-tool registry. */
