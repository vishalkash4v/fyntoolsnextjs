...
const Tool = dynamic(() => import("@/components/tools/ListRandomizer"), {
  ssr: false,
  loading: () => (
    <div
      ...
      aria-busy="true"
      aria-label="Loading List Randomizer"
      role="status"
    >
      Loading tool…
    </div>
...
/** Dedicated island — only loads ListRandomizer, not the multi-tool registry. */
