...
const Tool = dynamic(() => import("@/components/tools/NameGenerator"), {
  ssr: false,
  loading: () => (
    <div
      ...
      aria-busy="true"
      aria-label="Loading Name Generator"
      role="status"
    >
      Loading tool…
    </div>
...
/** Dedicated island — only loads NameGenerator, not the multi-tool registry. */
