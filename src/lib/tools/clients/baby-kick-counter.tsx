...
const Tool = dynamic(() => import("@/components/tools/BabyKickCounter"), {
  ssr: true,
  loading: () => (
    <div
      ...
      aria-busy="true"
      aria-label="Loading Baby Kick Counter"
      role="status"
    >
      Loading tool…
    </div>
...
/** Dedicated island — only loads BabyKickCounter, not the multi-tool registry. */
