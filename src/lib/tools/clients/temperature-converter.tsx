...
const Tool = dynamic(() => import("@/components/tools/TemperatureConverter"), {
  ssr: true,
  loading: () => (
    <div
      ...
      aria-busy="true"
      aria-label="Loading Temperature Converter"
      role="status"
    >
      Loading tool…
    </div>
...
/** Dedicated island — only loads TemperatureConverter, not the multi-tool registry. */
