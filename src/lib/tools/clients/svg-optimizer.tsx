...
const Tool = dynamic(() => import("@/components/tools/SvgOptimizer"), {
  ssr: false,
  loading: () => (
    <div
      ...
      aria-busy="true"
      aria-label="Loading Svg Optimizer"
      role="status"
    >
      Loading tool…
    </div>
...
/** Dedicated island — only loads SvgOptimizer, not the multi-tool registry. */
