...
const Tool = dynamic(() => import("@/components/tools/PercentageCalculator"), {
  ssr: true,
  loading: () => (
    <div
      ...
      aria-busy="true"
      aria-label="Loading Percentage Calculator"
      role="status"
    >
      Loading tool…
    </div>
...
/** Dedicated island — only loads PercentageCalculator, not the multi-tool registry. */
