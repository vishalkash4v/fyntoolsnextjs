...
const Tool = dynamic(() => import("@/components/tools/ConceptionDateCalculator"), {
  ssr: true,
  loading: () => (
    <div
      ...
      aria-busy="true"
      aria-label="Loading Conception Date Calculator"
      role="status"
    >
      Loading tool…
    </div>
...
/** Dedicated island — only loads ConceptionDateCalculator, not the multi-tool registry. */
