...
const Tool = dynamic(() => import("@/components/tools/PmsSymptomTracker"), {
  ssr: true,
  loading: () => (
    <div
      ...
      aria-busy="true"
      aria-label="Loading Pms Symptom Tracker"
      role="status"
    >
      Loading tool…
    </div>
...
/** Dedicated island — only loads PmsSymptomTracker, not the multi-tool registry. */
