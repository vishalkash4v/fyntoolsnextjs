...
const Tool = dynamic(() => import("@/components/tools/RegexTester"), {
  ssr: true,
  loading: () => (
    <div
      ...
      aria-busy="true"
      aria-label="Loading Regex Tester"
      role="status"
    >
      Loading tool…
    </div>
...
/** Dedicated island — only loads RegexTester, not the multi-tool registry. */
