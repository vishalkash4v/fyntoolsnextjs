...
const Tool = dynamic(() => import("@/components/tools/CssMinifier"), {
  ssr: false,
  loading: () => (
    <div
      ...
      aria-busy="true"
      aria-label="Loading Css Minifier"
      role="status"
    >
      Loading tool…
    </div>
...
/** Dedicated island — only loads CssMinifier, not the multi-tool registry. */
