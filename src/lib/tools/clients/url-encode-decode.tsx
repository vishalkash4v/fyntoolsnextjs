...
const Tool = dynamic(() => import("@/components/tools/UrlEncodeDecoder"), {
  ssr: true,
  loading: () => (
    <div
      ...
      aria-busy="true"
      aria-label="Loading Url Encode Decoder"
      role="status"
    >
      Loading tool…
    </div>
...
/** Dedicated island — only loads UrlEncodeDecoder, not the multi-tool registry. */
