...
const Tool = dynamic(() => import("@/components/tools/HashtagGenerator"), {
  ssr: true,
  loading: () => (
    <div
      ...
      aria-busy="true"
      aria-label="Loading Hashtag Generator"
      role="status"
    >
      Loading tool…
    </div>
...
/** Dedicated island — only loads HashtagGenerator, not the multi-tool registry. */
