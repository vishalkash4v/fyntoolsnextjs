...
const Tool = dynamic(() => import("@/components/tools/DateDifferenceCalculator"), {
  ssr: false,
  loading: () => (
    <div
      ...
      aria-busy="true"
      aria-label="Loading Date Difference Calculator"
      role="status"
    >
      Loading tool…
    </div>
...
/** Dedicated island — only loads DateDifferenceCalculator, not the multi-tool registry. */
