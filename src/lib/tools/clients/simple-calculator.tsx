...
const Tool = dynamic(() => import("@/components/tools/SimpleCalculator"), {
  ssr: true,
  loading: () => (
    <div
      ...
      aria-busy="true"
      aria-label="Loading Simple Calculator"
      role="status"
    >
      Loading tool…
    </div>
...
/** Dedicated island — only loads SimpleCalculator, not the multi-tool registry. */
