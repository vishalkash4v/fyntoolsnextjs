...
const Tool = dynamic(() => import("@/components/tools/OvulationCalculator"), {
  ssr: true,
  loading: () => (
    <div
      ...
      aria-busy="true"
      aria-label="Loading Ovulation Calculator"
      role="status"
    >
      Loading tool…
    </div>
...
/** Dedicated island — only loads OvulationCalculator, not the multi-tool registry. */
