...
const Tool = dynamic(() => import("@/components/tools/DailyTaskReportSaver"), {
  ssr: false,
  loading: () => (
    <div
      ...
      aria-busy="true"
      aria-label="Loading Daily Task Report Saver"
      role="status"
    >
      Loading tool…
    </div>
...
/** Dedicated island — only loads DailyTaskReportSaver, not the multi-tool registry. */
