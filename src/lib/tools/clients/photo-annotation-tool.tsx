...
const Tool = dynamic(() => import("@/components/tools/PhotoAnnotationTool"), {
  ssr: false,
  loading: () => (
    <div
      ...
      aria-busy="true"
      aria-label="Loading Photo Annotation Tool"
      role="status"
    >
      Loading tool…
    </div>
...
/** Dedicated island — only loads PhotoAnnotationTool, not the multi-tool registry. */
