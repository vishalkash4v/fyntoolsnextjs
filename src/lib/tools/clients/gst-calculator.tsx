...
const Tool = dynamic(() => import("@/components/tools/GstCalculator"), {
  ssr: false,
  loading: () => (
    <div
      ...
      aria-busy="true"
      aria-label="Loading Gst Calculator"
      role="status"
    >
      Loading tool…
    </div>
...
/** Dedicated island — only loads GstCalculator, not the multi-tool registry. */
