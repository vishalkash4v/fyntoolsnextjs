...
const Tool = dynamic(() => import("@/components/tools/FdCalculator"), {
  ssr: true,
  loading: () => (
    <div
      ...
      aria-busy="true"
      aria-label="Loading Fd Calculator"
      role="status"
    >
      Loading tool…
    </div>
...
/** Dedicated island — only loads FdCalculator, not the multi-tool registry. */
