...
const Tool = dynamic(() => import("@/components/tools/DuplicateLineRemover"), {
  ssr: true,
  loading: () => (
    <div
      ...
      aria-busy="true"
      aria-label="Loading Duplicate Line Remover"
      role="status"
    >
      Loading tool…
    </div>
...
/** Dedicated island — only loads DuplicateLineRemover, not the multi-tool registry. */
