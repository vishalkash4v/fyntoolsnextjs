...
const Tool = dynamic(() => import("@/components/tools/UsernameGenerator"), {
  ssr: true,
  loading: () => (
    <div
      ...
      aria-busy="true"
      aria-label="Loading Username Generator"
      role="status"
    >
      Loading tool…
    </div>
...
/** Dedicated island — only loads UsernameGenerator, not the multi-tool registry. */
