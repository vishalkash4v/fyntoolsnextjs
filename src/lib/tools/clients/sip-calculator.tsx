...
const Tool = dynamic(() => import("@/components/tools/SipCalculator"), {
  ssr: false,
  loading: () => (
    <div
      ...
      aria-busy="true"
      aria-label="Loading Sip Calculator"
      role="status"
    >
      Loading tool…
    </div>
...
/** Dedicated island — only loads SipCalculator, not the multi-tool registry. */
