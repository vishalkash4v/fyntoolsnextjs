...
const Tool = dynamic(() => import("@/components/tools/PpfCalculator"), {
  ssr: true,
  loading: () => (
    <div
      ...
      aria-busy="true"
      aria-label="Loading Ppf Calculator"
      role="status"
    >
      Loading tool…
    </div>
...
/** Dedicated island — only loads PpfCalculator, not the multi-tool registry. */
